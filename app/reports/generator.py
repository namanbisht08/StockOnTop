...
from app.reports.position_status import render_daily_status_message
...
def generate_daily_status_message(digest: List[Dict]) -> str:
    ...
    tracked position. The heavier per-position P&L/distance calculations and
    the portfolio summary live in app.reports.position_status.
    """
    return render_daily_status_message(digest)
